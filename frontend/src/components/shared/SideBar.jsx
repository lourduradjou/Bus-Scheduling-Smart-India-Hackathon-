...
const LOGOUT_LINK = {
	key: 'auth',
	label: 'Logout',
	// once logout is clicked,it will redirect to login page and clears the access token in the localStorage
	path: '/login',    
	icon: <TbLogout2 />,
	theme: 'red',
}
...
const SideBar = () => {
	...
	return (
		<div className='w-60 bg-[#00245c] text-gray-300 min-h-screen flex flex-col justify-between'>
			<div>
