		...
		<div className='ml-[17%] mr-[2%] employee-management'>
			<div className='table-container'>
				...
				<table className='employee-table'>
					<thead>
						<tr>
							<th className='tracking-wider'>Bus ID</th>
							<th className='tracking-wider'>Bus No</th>
							<th className='tracking-wider'>Bus Type</th>
							<th className='tracking-wider'>AC/Non-AC</th>
							<th className='tracking-wider'>Avg Mileage</th>
							<th className='tracking-wider'>Last Maintenance Date</th>
							<th className='tracking-wider'>Next Maintenance Date</th>
							<th className='tracking-wider'>Bus Status</th>
						</tr>
					</thead>
					<tbody>
						{bus.map((bus) => (
